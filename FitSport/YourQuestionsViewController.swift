//
//  YourQuestionsViewController.swift
//  FitSport
//
...
class YourQuestionsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
